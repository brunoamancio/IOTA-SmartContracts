...
- Open file `go.mod` and change the go module's name from `module github.com/brunoamancio/IOTA-SmartContracts` to `module github.com/<your_username>/<your_project_name>`
